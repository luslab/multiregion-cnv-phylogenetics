...
source("~/Wilms_tumour_project/bin/Original_George_Scripts/CGH_pipeline_source_file_v2.R")

#Load the processed mBAF
load("~/Wilms_tumour_project/results/2015-03-10/Threshold_mBAF_v3.Rdata")
